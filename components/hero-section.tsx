...
export function HeroSection() {
  return (
    <section
      ...
      className="relative flex w-full flex-col items-center justify-center text-center pt-32 pb-40 md:pt-40 md:pb-48 backgorund-white"
    >
      {/* <HeroBackground /> */}
      ...
      >
        <div id="hero-text-container" className="space-y-4 md:space-y-5 lg:space-y-6 max-w-md md:max-w-xl lg:max-w-3xl">
          <h1 className="text-primary-gradient text-3xl md:text-4xl lg:text-6xl font-semibold leading-tight">
      ...
      {/* The Dashboard Preview is now hidden.
        You can uncomment this block to show it again.
      */}
      {/*
      <div
